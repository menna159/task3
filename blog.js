...
for (let i = 0; i < posts.length; i++) {
  ...
  document.getElementById("post_1_p").innerText=element.date;
  ...
  document.getElementById("post_2_p").innerText=element.date;
  ...
  document.getElementById("post_3_P").innerText=element.date;
